...
INSERT INTO recipe (name, description, cook_time, servings, vegetarian) VALUES ('Lemon Chicken', 'Lemon chicken is really just a simple baked chicken recipe, jazzed up with some punchy ingredients that add lots of flavor without taking away from how super-healthy baked chicken breasts are', 5, 6, 0);
